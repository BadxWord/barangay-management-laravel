...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg flex flex-row gap-5 p-3">
    <table id="customers">
        ...
        <tr>
            ...
            <td>{{ $content->belongsToFile->name }}</td>
            @else
            <td>{{ $content->belongsToFile->name }} ( Reprinted )</td>
            @endif
            <td>{{ $content->otr }}</td>
                            ...
                            <form  action="{{ route('admin.residentlist.reprint',$content->id) }}" method="POST" class="bg-white dark:bg-gray-700">
                                ...
                                <div class="p-4 md:p-5 space-y-4  text-2xl">
                                 <div class="form-group">
                                    ...
                                    <input type="text" placeholder="file name" value="{{ $content->belongsToFile->name }}" name="name" class="form-control">
                                 </div>
                                 <div class="form-group">
